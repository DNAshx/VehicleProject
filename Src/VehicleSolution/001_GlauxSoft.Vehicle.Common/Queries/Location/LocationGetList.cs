...
{
    /// <summary>Class for query definition and access to query called LocationGetList in evidence class Location</summary>
    ...
    [global::System.Diagnostics.DebuggerDisplay("ClassName={ClassName}, QueryName=LocationGetList")]
    [EvidenceQuery(UseRepoConstants = true)]
    public class LocationGetList : QueryBase
    {
        //###########################################################################
        ...
        public override string ClassName
        {
            get
            {
                return myConst.Location.CLASSNAME;
            }
        }
        ...
        internal LocationGetList(QueryFactoryContext context)
            : base(context)
        {
        }
        ...
        protected override ComplexQuery LoadQueryInternal()
        {
            ...
            base.VisitClass(myConst.Location.CLASSNAME);
            ...
            AttributeQuery query1 = AttributeQuery.Create(Directory.get_ClassDescriptor(myConst.Location.CLASSNAME).ID);
        ...
        /// <summary>
        /// Executes query "LocationGetList" and returns result as list of business objects. 
        ...
        /// <summary>
        /// Executes query "LocationGetList" and returns result as list object business objects of type T.
        ...
        /// <summary>
        /// Returns a queryable instance for query "LocationGetList". See <see cref="CoreBusinessObject.AsQueryable"/> for queryable usage.
        /// </summary>
    ...
    public partial class LocationQueryAccessor : QueryAccessorBase
    {
        /// <summary>
        /// </summary>
        public LocationGetList LocationGetList
        {
            get { return base.GetQuery<LocationGetList>(); }
        }
    }
